-- 200건 기준 10초 이내: project_name 기준 일괄 upsert (데이터 일원화)
-- 호출: POST /rest/v1/rpc/update_multiple_consultations_from_sheet body: { "rows": [ { project_name, link?, start_date?, update_date?, created_at? }, ... ] }
