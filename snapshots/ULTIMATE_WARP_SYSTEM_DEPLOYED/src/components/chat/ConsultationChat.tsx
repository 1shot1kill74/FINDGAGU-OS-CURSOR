...
import { Send, Paperclip, FileText, Loader2, MessageCircle, Layers, FileSpreadsheet, Presentation, File, Pencil, Trash2 } from 'lucide-react'
  ...
  return (
    <div className="flex flex-col h-full min-h-0 rounded-lg bg-slate-100">
      ...
      <div
        ...
        className="relative flex-1 overflow-y-auto min-h-[200px] space-y-3 py-3 bg-slate-100"
      >
        {loadingMore && (
              ...
              return (
                <div key={m.id} className="flex justify-center my-2" ref={highlightMessageId === m.id ? highlightRef : undefined}>
                  <button
                    ...
                    className={cn(
                      'rounded-lg px-4 py-2.5 text-xs text-center max-w-[min(92%,420px)] text-slate-900 bg-white border border-slate-200 shadow-sm',
