...
정식 상품 A/B/C와 별도로, 지금 당장 판매할 가장 작은 오퍼는
`SHOWROOM_MANUAL_PILOT_PACKAGE.md`에 정의한 `수동 유료 파일럿`이다.

이 파일럿은 정식 SaaS 이전 단계에서 고객 1곳을 수동 온보딩하며
공개 쇼룸 가치와 실제 사용 반응을 검증하기 위한 판매 단위다.
...
- 정식 SaaS보다 먼저 `수동 유료 파일럿`을 판다
- 고객 1곳을 수동 온보딩하며 실제 자료 흐름과 링크 사용 반응을 본다
- 이 단계에서는 공개 쇼룸과 제한된 자산 정리만 다룬다
- 숏츠, 광고, 상담관리, 멀티테넌시는 판매 범위에서 뺀다
